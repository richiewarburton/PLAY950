...
PLAY950 0.13.0 targets macOS 14 or later and Ableton Live 12. The VST3 binary is
...
4. Confirm version 0.13.0, confirm that the host exposes no audio input bus, and
